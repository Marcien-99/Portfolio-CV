          ...
          <form action={handleSubmit} className="bg-[#1A1A1A] border border-white/5 rounded-[2.5rem] p-8 md:p-12 shadow-2xl space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-3">
                <Label htmlFor="title_fr" className="text-sm font-medium text-white/70">Diplôme / Titre (Français) *</Label>
                <Input 
                  id="title_fr" 
                  name="title_fr" 
                  required 
              ...
              <div className="space-y-3">
                <Label htmlFor="institution" className="text-sm font-medium text-white/70">Établissement *</Label>
                <Input 
                  id="institution" 
                  name="institution" 
                  required 
            ...
            <div className="flex flex-col-reverse sm:flex-row justify-end gap-4 pt-8 mt-8 border-t border-white/5">
              <Button type="button" variant="ghost" onClick={() => router.push('/admin/formations')} disabled={isPending} className="w-full sm:w-auto px-6 py-3 rounded-full text-white/70 hover:text-white hover:bg-[#222222]">
                Annuler
              </Button>
