        ...
        <form action={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <Label htmlFor="title_fr">Titre du poste (Français) *</Label>
              <Input 
                id="title_fr" 
                name="title_fr" 
                required 
            ...
            <div className="space-y-3">
              <Label htmlFor="title_en">Titre du poste (Anglais) *</Label>
              <Input 
                id="title_en" 
                name="title_en" 
                required 
          ...
          <div className="space-y-3 pt-4 border-t border-border/10">
            <Label>Domaines d'expertise sollicités</Label>
          ...
          <div className="flex justify-end gap-4 pt-6">
            <Button type="button" variant="ghost" onClick={() => router.push('/admin/experiences')} disabled={isPending}>
              Annuler
            </Button>
