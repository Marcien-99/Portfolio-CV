...
- **Phase 1 — Multi-profils de CV dans l'administration, Bios et Aperçu PDF (Hors PRD)** :
  ...
  - **Panneau de personnalisation** : Ajout d'un encart pour définir un résumé spécifique au profil (Bio FR/EN), un interrupteur pour afficher ou masquer le lien GitHub, et un interrupteur pour rendre le CV disponible au téléchargement public.
